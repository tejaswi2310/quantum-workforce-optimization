...
def run_sanity_check():
    ...
    # Check 1: CSVs exist
    expected_files = [
        os.path.join(results_path, "shift_schedule.csv"),
        os.path.join(results_path, "queue_validation_results.csv"),
        os.path.join(results_path, "agent_shifts_detailed.csv"),
        os.path.join(results_path, "erlang_requirement_validation.csv"),
        os.path.join(data_path, "forecast_evaluation.csv")
    ]
    ...
    df_shifts = pd.read_csv(os.path.join(results_path, "shift_schedule.csv"))
    ...
    df_queue = pd.read_csv(os.path.join(results_path, "queue_validation_results.csv"))
